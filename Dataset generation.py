...
# 1) Ensure the date columns are valid
...
# 3) Keep the abortus/partus mask as a Series (not a DataFrame)
...
# 6) ref_start (use .loc on both sides so the index stays aligned)
...
# Combine chronic and infectious conditions
all_conditions = {}
